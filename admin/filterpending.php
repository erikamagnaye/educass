								...
								<div class="card-header">
									<div class="card-head-row">
										...
										<div class="card-title" style=" margin-right: 10px;"><?php echo $filbrgy?></div>
                                            ...
                                            <a href="print_filter_pending_current.php?recent=<?=$recent?>&filbrgy=<?=$filbrgy?>&year=<?=$level_condition?>" class="btn btn-danger btn-border btn-round btn-sm" title="view and print">
...
<?php 
    ...
    where application.educid=? and brgy=? and `year` LIKE ? and application.appstatus = 'Pending' ORDER BY `year` ASC, lastname ASC";
