                                            ...
                                            <div class="dashboard">
                                                <div class="card bg-info"  >
                                                    ...
                                                    <a href="student.php" class="btn">
                                                        <h2 style="color: white;"><?= $regstudent ?></h2>
                                                ...
                                                <div class="card" style="background-color: #ED3EF7;">
                                                    ...
                                                    <a href="staff.php" class="btn">
                                                        <h2 style="color: white;"><?= $staffcount ?></h2>
                                                ...
                                                <div class="card" style="background-color: #185519;">
                                                    ...
                                                    <a href="educaids.php" class="btn">
                                                        <h2 style="color: white;"><?= $totaleduc ?></h2>
                                                        <h5  style="color: white;"> Educational Assistance</h5>
                                                    </a>
                                                </div>
                                                <!--      <div class="card">
