                                    ...
                                    <div class="card-header">
                                        <div class="card-head-row">
                                            ...
                                            <div class="card-tools">
                                                ...
                                                <a href="model/export_all_previous.php?educreportid=<?php echo $educreportid ?>"
                                                    class="btn btn-secondary btn-border btn-round btn-sm" title="Download">
                                                    <i class="fa fa-file"></i>
                                                    Export CSV
                                                </a>
                                                <a href="educ_report.php?educreportid=<?php echo $educreportid ?>"
                                                    class="btn btn-danger btn-border btn-round btn-sm" title="Download">
...
where application.educid=$educreportid  ORDER BY brgy ASC, `year` ASC, lastname ASC";
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($view_data)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="<?php echo htmlspecialchars($imageUrl); ?>" alt=""
                                                            ...
                                                            <td>
                                                                <a type="button"
                                                                    href="applicant_info.php?studid=<?php echo $studid; ?>&educid=<?php echo $educreportid; ?>&appid=<?php echo $appid; ?>"
                                                                    class="btn btn-link btn-info" title="Edit Data">
