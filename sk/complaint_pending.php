                                        ...
                                        <div container-fluid>
                                            <div class="dashboard">
                                                ...
                                                <div class="card"style="background-color:#06D001;">
                                                    <div class="card-icon" style="color:white;"><i class="fa-solid fa-hourglass-end"></i></div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="dataTable" class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT * FROM `concerns`  JOIN student 
                                                on concerns.studid = student.studid where brgy= '$skpos'  AND `status`= 'Pending' order by `date` desc"; // SQL query to fetch all table data
