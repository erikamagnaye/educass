                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="card">
                                                    ...
                                                    View
                                                                ...
                                                                <a href="model/export_previousrejected.php?educreportid=<?php echo $educreportid ?>" class="btn btn-secondary btn-border btn-round btn-sm" title="Download">
                                                    ...
                                                    where application.educid=$educreportid and brgy = '$skpos' and application.appstatus = 'Rejected' ORDER BY lastname ASC";
  ...
  <!--PRINT -->
        ...
        <script>
            ...
            function openPrintModal() {
                ...
                $.ajax({
                    url: 'print_rejectedprevious.php', // Create this PHP file to return HTML content
                    type: 'GET',
