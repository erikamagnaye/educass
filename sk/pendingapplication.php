                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-head-row">
                                                            ...
                                                            <div class="card-tools">
                                                                <a href="printpendingstudent.php" class="btn btn-danger btn-border btn-round btn-sm" title="view and print">
                                                    ...
                                                    where application.educid=$recent and brgy = '$skpos' AND appstatus= 'Pending' ORDER BY lastname ASC";
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <td><?php echo $count; ?></td>
                                                                            ...
                                                                            <td>
                                                                                <a type="button" href="view_pending_application.php?studid=<?php echo $studid; ?>&educid=<?php echo $recent; ?>&appid=<?php echo $appid; ?>" class="btn btn-link btn-info" title="Edit Data">
