...
where application.educid=$educreportid and brgy = $skpos and application.appstatus = 'Approved' ORDER BY `year` ASC, lastname ASC";
...
$filename = $skpos . " Approved Applicants.csv";
