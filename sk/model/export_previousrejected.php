...
where application.educid=$educreportid and brgy = $skpos and application.appstatus = 'Rejected' ORDER BY `year` ASC, lastname ASC";
...
$filename = $skpos . " Rejected Applicants.csv";
