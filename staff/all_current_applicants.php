...
if (!isset($_SESSION['staffid']) || strlen($_SESSION['staffid']) == 0 || in_array($_SESSION['role'], $skTypes)) {
                                  ...
                                  <div class="card-header">
                                      <div class="card-head-row">
                                          ...
                                          <a href="#add" data-toggle="modal" class="btn btn-secondary btn-border btn-round btn-sm" title="Post Assistance">
                                              ...
                                              <a href="model/export_allcurrent.php?recent=<?=$recent?>" class="btn btn-success btn-border btn-round btn-sm" title="Download">
                                                  <i class="fa fa-file"></i>
                                                  Export CSV
                                              </a>
                                              <a href="employeedashboard.php" class="btn btn-danger btn-border btn-round btn-sm" title="Download">
  ...
  where application.educid=$recent  ORDER BY brgy ASC, `year` ASC, lastname ASC";
           ...
           <?php if (isset($_SESSION['message'])) : ?> 
              ...
              $(document).ready(function() {
               ...
               function openPrintModal() {
                ...
                $.ajax({
                    url: 'print_all_current.php', // this is the file where data to display and print are located
                    type: 'GET',
