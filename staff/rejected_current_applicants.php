...
if (!isset($_SESSION['staffid']) || strlen($_SESSION['staffid']) == 0 || in_array($_SESSION['role'], $skTypes)) {
                                  ...
                                  <div class="card-header">
                                      <div class="card-head-row">
                                          ...
                                          <a href="#add" data-toggle="modal" class="btn btn-secondary btn-border btn-round btn-sm" title="Post Assistance">
                                              ...
                                              <a href="model/export_rejected_current.php?recent=<?=$recent?>" class="btn btn-danger btn-border btn-round btn-sm" title="Download">
                                                  <i class="fa fa-file"></i>
                                                  Export CSV
                                              </a>
                                              <a href="employeedashboard.php" class="btn btn-danger btn-border btn-round btn-sm" >
  ...
  where application.educid=$recent and appstatus = 'Rejected' ORDER BY brgy ASC, `year` ASC, lastname ASC";
      ...
      <?php include 'templates/footer.php' ?>
           ...
           <?php if (isset($_SESSION['message'])) : ?> 
              ...
              $(document).ready(function() {
                ...
                $.ajax({
                    url: 'print_rejected_current.php', // Create this PHP file to return HTML content
                    type: 'GET',
