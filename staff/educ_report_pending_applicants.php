				...
				<div class="panel-header ">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-black fw-bold">Staff</h2>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Pending Applicants</div>
										<a href="#add" data-toggle="modal" class="btn btn-secondary btn-border btn-round btn-sm" title="Post Assistance">
                                                    <i class="fa fa-filter"></i>
                                                   Filter Option
                                                </a>
											<div class="card-tools">
                                            <a href="#" class="btn btn-primary btn-border btn-round btn-sm" title="view and print" onclick="openPrintModal()">
  <i class="fa fa-eye"></i>
  View
</a>
                                            <a href="model/export_previous_pending.php" class="btn btn-success btn-border btn-round btn-sm" title="Download">
...
where application.educid=$educreportid and appstatus = 'Pending' ORDER BY brgy ASC, `year` ASC, lastname ASC";
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="filterpending.php">
...
<div class="modal fade" id="printModal" tabindex="-1" role="dialog" aria-labelledby="printModalLabel" aria-hidden="true">
    ...
    $.ajax({
        url: 'print_pending_previous.php', // Create this PHP file to return HTML content
        type: 'GET',
