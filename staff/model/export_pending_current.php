...
where application.educid=$educreportid where application.appstatus= 'Pending'  ORDER BY brgy ASC, `year` ASC, lastname ASC";
...
header('Content-Disposition: attachment; filename=Pending Applicants.csv');
