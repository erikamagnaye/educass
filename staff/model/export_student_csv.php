...
// get Users
$query = "SELECT lastname,firstname,midname,`email`, `birthday`,`contact_no`, `brgy`, `municipality`, `province`, `street_name`, `gender`, citizenship,`religion`,`age`,`civilstatus` FROM `student` ORDER BY brgy ASC, lastname ASC";
